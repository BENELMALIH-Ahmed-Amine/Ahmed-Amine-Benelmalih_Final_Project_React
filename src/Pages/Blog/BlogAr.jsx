...
const BlogAr = () => {
    ...
    return (
        <div className='w-full flex justify-center'>
            <div className='w-[60%] flex justify-between max-sm:flex-col'>
                <section className='w-[811px] pb-20'>
                    <article className='w-full pb-6 text-[#888888]'>
                        <div className='w-full'><img className='w-full h-full' src={Images[Artical.img]} alt={Artical.title + "by" + Artical.author} /></div>
