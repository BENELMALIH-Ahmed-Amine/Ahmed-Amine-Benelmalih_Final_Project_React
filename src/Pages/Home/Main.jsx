        ...
        <main className='w-full flex flex-col items-center'>
            <article className='w-[60%] py-[40px] flex justify-between max-sm:w-[80%] max-sm:block'>
                <section className='w-[350px] space-y-12 max-sm:w-full max-sm:mb-12'>
                    <div className='w-full h-[480px] max-sm:h-[640px] relative'>
                        <img className='w-full h-full hover:scale-105' src={Images.card1} alt="" />
                        <button onClick={() => shop('/shop')} className='px-10 py-2.5 bg-white hover:text-white hover:bg-[#e65540] absolute bottom-5 left-23.5 max-sm:left-43 uppercase'>Dresses</button>
                    </div>
                    <div className='w-full h-[340px] max-sm:h-[455px] relative'>
                        <img className='w-full h-full hover:scale-105' src={Images.card2} alt="" />
                        <button onClick={() => shop('/shop')} className='px-10 py-2.5 bg-white hover:text-white hover:bg-[#e65540] absolute bottom-5 left-23.5 max-sm:left-43 uppercase'>Sunglasses</button>
                    </div>
                </section>

                <section className='w-[350px] space-y-12 max-sm:w-full max-sm:mb-12'>
                    <div className='w-full h-[340px] max-sm:h-[455px] relative'>
                        <img className='w-full h-full hover:scale-105' src={Images.card3} alt="" />
                        <button onClick={() => shop('/shop')} className='px-10 py-2.5 bg-white hover:text-white hover:bg-[#e65540] absolute bottom-5 left-23.5 max-sm:left-43 uppercase'>Watches</button>
                    </div>
                    <div className='w-full h-[480px] max-sm:h-[640px] relative'>
                        <img className='w-full h-full hover:scale-105' src={Images.card4} alt="" />
                        <button onClick={() => shop('/shop')} className='px-10 py-2.5 bg-white hover:text-white hover:bg-[#e65540] absolute bottom-5 left-23.5 max-sm:left-43 uppercase'>Footerwear</button>
                    </div>
                </section>

                <section className='w-[350px] space-y-12 max-sm:w-full max-sm:mb-12'>
                    <div className='w-full h-[480px] max-sm:h-[640px] relative'>
                        <img className='w-full h-full hover:scale-105' src={Images.card5} alt="" />
                        <button onClick={() => shop('/shop')} className='px-10 py-2.5 bg-white hover:text-white hover:bg-[#e65540] absolute bottom-5 left-23.5 max-sm:left-43 uppercase'>Bags</button>
                    </div>
                    <div className='w-full h-[340px] max-sm:h-[455px] relative'>
                        <img className='w-full h-full hover:scale-105' src={Images.card6} alt="" />
                        <button onClick={() => shop('/shop')} className='px-10 py-2.5 bg-white hover:text-white hover:bg-[#e65540] absolute bottom-5 left-23.5 max-sm:left-43 uppercase'>Accessories</button>
                    </div>
                </section>
            </article>
            ...
            <div className='w-full h-fit py-14 bg-[#f2f2f2] flex justify-center'>
                <article className='w-[60%] h-fit flex justify-center gap-8 max-sm:w-[80%] max-sm:block max-sm:space-y-8'>
                    <section className='w-[48.7%] h-[425px] max-sm:w-full relative'>
                        <div className='w-full h-full'><img className='w-full h-full hover:scale-105' src={Images.banner2} alt="" /></div>
                    ...
                    <section className='w-[48.7%] h-[425px] flex justify-center text-[#737373] max-sm:w-full relative'>
                        <div className='w-full h-full'><img className='w-full h-full hover:scale-105' src={Images.banner3} alt="" /></div>
