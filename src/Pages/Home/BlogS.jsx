    ...
    return (
        <article className='w-[60%] pt-[94px] pb-[65px]'>
            <section className='w-full pb-[52px] grid place-content-center'>
                <h2 className='text-[32px] font-bold uppercase'>Our Blog</h2>
            </section>
                        ...
                        <Link to={`/blog/${b.id}`}>
                            <article className='w-full h-[455px] px-4 pb-8 text-[#888888]'>
                                ...
                                <div className='pt-3.5 space-y-3'>
                                    <Link to={`/blog/${b.id}`} className='w-full text-lg font-medium text-[#333333] hover:text-[#e65540] transition-colors duration-300'>
                                        <h4>{b.title}</h4>
                                    </Link>
                                    ...
                                    <p className='text-[13.5px]'>{b.des}</p>
                                </div>
                            </article>
                        </Link>
                    )
